...
public class TridentStreamInsertRel extends StormStreamInsertRelBase implements TridentRel {
    public TridentStreamInsertRel(RelOptCluster cluster, RelTraitSet traits, RelOptTable table, Prepare.CatalogReader catalogReader, RelNode child, Operation operation, List<String> updateColumnList, boolean flattened) {
