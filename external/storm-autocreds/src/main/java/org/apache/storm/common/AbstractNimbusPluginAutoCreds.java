 ...
 */
public abstract class AbstractNimbusPluginAutoCreds
    implements INimbusCredentialPlugin, ICredentialsRenewer, CredentialKeyProvider {
    private static final Logger LOG = LoggerFactory.getLogger(AbstractNimbusPluginAutoCreds.class);
    ...
    @Override
    public void populateCredentials(Map<String, String> credentials, Map topologyConf) {
        try {
