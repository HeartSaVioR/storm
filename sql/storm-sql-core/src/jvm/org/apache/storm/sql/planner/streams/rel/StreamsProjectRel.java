...
public class StreamsProjectRel extends StormProjectRelBase implements StreamsRel {
    public StreamsProjectRel(RelOptCluster cluster, RelTraitSet traits, RelNode input, List<? extends RexNode> projects, RelDataType rowType) {
    ...
    public void streamsPlan(StreamsPlanCreator planCreator) throws Exception {
        ...
        final Stream<Values> finalStream = inputStream.map(new EvaluationFunction(projectionInstance, outputCount, planCreator.getDataContext()));
