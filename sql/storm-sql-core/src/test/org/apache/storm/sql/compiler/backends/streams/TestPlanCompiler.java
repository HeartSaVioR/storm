...
public class TestPlanCompiler {
  ...
  @Before
  public void setUp() {
    TestUtils.MockBolt.getCollectedValues().clear();
  }
  ...
  public void testCompile() throws Exception {
    ...
    runStormTopology(TestUtils.MockBolt.getCollectedValues(), EXPECTED_VALUE_SIZE, proc, topo);
  ...
  public void testInsert() throws Exception {
    ...
    runStormTopology(TestUtils.MockInsertBolt.getCollectedValues(), EXPECTED_VALUE_SIZE, proc, topo);
  ...
  public void testCaseStatement() throws Exception {
    ...
    Assert.assertArrayEquals(new Values[]{new Values("A"), new Values("b"), new Values("A"), new Values("abcd#"), new Values("A")},
  ...
  private void runStormTopology(final List<?> watchedList, final int expectedValueSize, AbstractStreamsProcessor proc,
                                StormTopology topo) throws Exception {
    ...
    try (LocalTopology stormTopo = cluster.submitTopology("storm-sql", conf, topo)) {
      waitForCompletion(1000 * 1000, new Callable<Boolean>() {
        @Override
        public Boolean call() throws Exception {
          return watchedList.size() < expectedValueSize;
        }
      });
    } finally {
