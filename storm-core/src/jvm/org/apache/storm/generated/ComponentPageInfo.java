...
public class ComponentPageInfo implements org.apache.thrift.TBase<ComponentPageInfo, ComponentPageInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ComponentPageInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.window_to_stats = new HashMap<String,ComponentAggregateStats>(2*_map430.size);
                String _key431;
                ...
                for (int _i433 = 0; _i433 < _map430.size; ++_i433)
                {
                  ...
                  _val432.read(iprot);
                  struct.window_to_stats.put(_key431, _val432);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.gsid_to_input_stats = new HashMap<GlobalStreamId,ComponentAggregateStats>(2*_map434.size);
                GlobalStreamId _key435;
                ComponentAggregateStats _val436;
                for (int _i437 = 0; _i437 < _map434.size; ++_i437)
                {
                  _key435 = new GlobalStreamId();
                  _key435.read(iprot);
                  _val436 = new ComponentAggregateStats();
                  _val436.read(iprot);
                  struct.gsid_to_input_stats.put(_key435, _val436);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.sid_to_output_stats = new HashMap<String,ComponentAggregateStats>(2*_map438.size);
                String _key439;
                ...
                for (int _i441 = 0; _i441 < _map438.size; ++_i441)
                {
                  ...
                  _val440.read(iprot);
                  struct.sid_to_output_stats.put(_key439, _val440);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.exec_stats = new ArrayList<ExecutorAggregateStats>(_list442.size);
                ExecutorAggregateStats _elem443;
                for (int _i444 = 0; _i444 < _list442.size; ++_i444)
                {
                  _elem443 = new ExecutorAggregateStats();
                  _elem443.read(iprot);
                  struct.exec_stats.add(_elem443);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.window_to_stats != null) {
        if (struct.is_set_window_to_stats()) {
          oprot.writeFieldBegin(WINDOW_TO_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, ComponentAggregateStats> _iter448 : struct.window_to_stats.entrySet())
            {
      ...
      if (struct.gsid_to_input_stats != null) {
        if (struct.is_set_gsid_to_input_stats()) {
          oprot.writeFieldBegin(GSID_TO_INPUT_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<GlobalStreamId, ComponentAggregateStats> _iter449 : struct.gsid_to_input_stats.entrySet())
            {
              _iter449.getKey().write(oprot);
      ...
      if (struct.sid_to_output_stats != null) {
        if (struct.is_set_sid_to_output_stats()) {
          oprot.writeFieldBegin(SID_TO_OUTPUT_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, ComponentAggregateStats> _iter450 : struct.sid_to_output_stats.entrySet())
            {
      ...
      if (struct.exec_stats != null) {
        if (struct.is_set_exec_stats()) {
          oprot.writeFieldBegin(EXEC_STATS_FIELD_DESC);
          {
            ...
            for (ExecutorAggregateStats _iter451 : struct.exec_stats)
            {
      ...
      if (struct.errors != null) {
        if (struct.is_set_errors()) {
          oprot.writeFieldBegin(ERRORS_FIELD_DESC);
          {
            ...
            for (ErrorInfo _iter452 : struct.errors)
            {
  ...
  private static class ComponentPageInfoTupleScheme extends TupleScheme<ComponentPageInfo> {
      ...
      if (struct.is_set_window_to_stats()) {
        {
          ...
          for (Map.Entry<String, ComponentAggregateStats> _iter453 : struct.window_to_stats.entrySet())
          {
      ...
      if (struct.is_set_gsid_to_input_stats()) {
        {
          ...
          for (Map.Entry<GlobalStreamId, ComponentAggregateStats> _iter454 : struct.gsid_to_input_stats.entrySet())
          {
            _iter454.getKey().write(oprot);
      ...
      if (struct.is_set_sid_to_output_stats()) {
        {
          ...
          for (Map.Entry<String, ComponentAggregateStats> _iter455 : struct.sid_to_output_stats.entrySet())
          {
      ...
      if (struct.is_set_exec_stats()) {
        {
          ...
          for (ExecutorAggregateStats _iter456 : struct.exec_stats)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ComponentPageInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.window_to_stats = new HashMap<String,ComponentAggregateStats>(2*_map458.size);
          String _key459;
          ...
          for (int _i461 = 0; _i461 < _map458.size; ++_i461)
          {
            ...
            _val460.read(iprot);
            struct.window_to_stats.put(_key459, _val460);
          }
        }
        struct.set_window_to_stats_isSet(true);
      }
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TMap _map462 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.gsid_to_input_stats = new HashMap<GlobalStreamId,ComponentAggregateStats>(2*_map462.size);
          GlobalStreamId _key463;
          ComponentAggregateStats _val464;
          for (int _i465 = 0; _i465 < _map462.size; ++_i465)
          {
            _key463 = new GlobalStreamId();
            _key463.read(iprot);
            _val464 = new ComponentAggregateStats();
            _val464.read(iprot);
            struct.gsid_to_input_stats.put(_key463, _val464);
          }
        }
        struct.set_gsid_to_input_stats_isSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.sid_to_output_stats = new HashMap<String,ComponentAggregateStats>(2*_map466.size);
          String _key467;
          ...
          for (int _i469 = 0; _i469 < _map466.size; ++_i469)
          {
            ...
            _val468.read(iprot);
            struct.sid_to_output_stats.put(_key467, _val468);
          }
        }
        struct.set_sid_to_output_stats_isSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.exec_stats = new ArrayList<ExecutorAggregateStats>(_list470.size);
          ExecutorAggregateStats _elem471;
          for (int _i472 = 0; _i472 < _list470.size; ++_i472)
          {
            _elem471 = new ExecutorAggregateStats();
            _elem471.read(iprot);
            struct.exec_stats.add(_elem471);
          }
        }
        struct.set_exec_stats_isSet(true);
      }
