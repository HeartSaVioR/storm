            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map642.size);
                String _key643;
                ThriftSerializedObject _val644;
                for (int _i645 = 0; _i645 < _map642.size; ++_i645)
                {
                  _key643 = iprot.readString();
                  _val644 = new ThriftSerializedObject();
                  _val644.read(iprot);
                  struct.serialized_parts.put(_key643, _val644);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LocalStateData struct) throws org.apache.thrift.TException {
      ...
      if (struct.serialized_parts != null) {
        oprot.writeFieldBegin(SERIALIZED_PARTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, ThriftSerializedObject> _iter646 : struct.serialized_parts.entrySet())
          {
  ...
  private static class LocalStateDataTupleScheme extends TupleScheme<LocalStateData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, ThriftSerializedObject> _iter647 : struct.serialized_parts.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map648 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map648.size);
        String _key649;
        ThriftSerializedObject _val650;
        for (int _i651 = 0; _i651 < _map648.size; ++_i651)
        {
          _key649 = iprot.readString();
          _val650 = new ThriftSerializedObject();
          _val650.read(iprot);
          struct.serialized_parts.put(_key649, _val650);
        }
      }
      struct.set_serialized_parts_isSet(true);
    }
