        ...
        switch (schemeField.id) {
          ...
          case 2: // PORT
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set548 = iprot.readSetBegin();
                struct.port = new HashSet<Long>(2*_set548.size);
                long _elem549;
                for (int _i550 = 0; _i550 < _set548.size; ++_i550)
                {
                  _elem549 = iprot.readI64();
                  struct.port.add(_elem549);
                }
                iprot.readSetEnd();
              }
  ...
  private static class NodeInfoTupleScheme extends TupleScheme<NodeInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NodeInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_node_isSet(true);
      {
        ...
        struct.port = new HashSet<Long>(2*_set553.size);
        long _elem554;
        for (int _i555 = 0; _i555 < _set553.size; ++_i555)
        {
          _elem554 = iprot.readI64();
          struct.port.add(_elem554);
        }
      }
      struct.set_port_isSet(true);
    }
