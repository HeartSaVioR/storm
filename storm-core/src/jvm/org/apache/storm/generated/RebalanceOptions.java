...
public class RebalanceOptions implements org.apache.thrift.TBase<RebalanceOptions, RebalanceOptions._Fields>, java.io.Serializable, Cloneable, Comparable<RebalanceOptions> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.num_executors = new HashMap<String,Integer>(2*_map476.size);
                String _key477;
                int _val478;
                for (int _i479 = 0; _i479 < _map476.size; ++_i479)
                {
                  ...
                  struct.num_executors.put(_key477, _val478);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.num_executors != null) {
        if (struct.is_set_num_executors()) {
          oprot.writeFieldBegin(NUM_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter480 : struct.num_executors.entrySet())
            {
              oprot.writeString(_iter480.getKey());
              oprot.writeI32(_iter480.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class RebalanceOptionsTupleScheme extends TupleScheme<RebalanceOptions> {
      ...
      if (struct.is_set_num_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter481 : struct.num_executors.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, RebalanceOptions struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map482 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.num_executors = new HashMap<String,Integer>(2*_map482.size);
          String _key483;
          int _val484;
          for (int _i485 = 0; _i485 < _map482.size; ++_i485)
          {
            ...
            struct.num_executors.put(_key483, _val484);
          }
        }
        struct.set_num_executors_isSet(true);
      }
