...
public class SupervisorInfo implements org.apache.thrift.TBase<SupervisorInfo, SupervisorInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.used_ports = new ArrayList<Long>(_list512.size);
                long _elem513;
                for (int _i514 = 0; _i514 < _list512.size; ++_i514)
                {
                  _elem513 = iprot.readI64();
                  struct.used_ports.add(_elem513);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.meta = new ArrayList<Long>(_list515.size);
                long _elem516;
                for (int _i517 = 0; _i517 < _list515.size; ++_i517)
                {
                  _elem516 = iprot.readI64();
                  struct.meta.add(_elem516);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.scheduler_meta = new HashMap<String,String>(2*_map518.size);
                String _key519;
                String _val520;
                for (int _i521 = 0; _i521 < _map518.size; ++_i521)
                {
                  ...
                  struct.scheduler_meta.put(_key519, _val520);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.resources_map = new HashMap<String,Double>(2*_map522.size);
                String _key523;
                double _val524;
                for (int _i525 = 0; _i525 < _map522.size; ++_i525)
                {
                  _key523 = iprot.readString();
                  _val524 = iprot.readDouble();
                  struct.resources_map.put(_key523, _val524);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.used_ports != null) {
        if (struct.is_set_used_ports()) {
          oprot.writeFieldBegin(USED_PORTS_FIELD_DESC);
          {
            ...
            for (long _iter526 : struct.used_ports)
            {
      ...
      if (struct.scheduler_meta != null) {
        if (struct.is_set_scheduler_meta()) {
          oprot.writeFieldBegin(SCHEDULER_META_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter528 : struct.scheduler_meta.entrySet())
            {
      ...
      if (struct.resources_map != null) {
        if (struct.is_set_resources_map()) {
          oprot.writeFieldBegin(RESOURCES_MAP_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter529 : struct.resources_map.entrySet())
            {
              oprot.writeString(_iter529.getKey());
              oprot.writeDouble(_iter529.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class SupervisorInfoTupleScheme extends TupleScheme<SupervisorInfo> {
      ...
      if (struct.is_set_used_ports()) {
        {
          ...
          for (long _iter530 : struct.used_ports)
          {
      ...
      if (struct.is_set_scheduler_meta()) {
        {
          ...
          for (Map.Entry<String, String> _iter532 : struct.scheduler_meta.entrySet())
          {
      ...
      if (struct.is_set_resources_map()) {
        {
          ...
          for (Map.Entry<String, Double> _iter533 : struct.resources_map.entrySet())
          {
            oprot.writeString(_iter533.getKey());
            oprot.writeDouble(_iter533.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SupervisorInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list534 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.used_ports = new ArrayList<Long>(_list534.size);
          long _elem535;
          for (int _i536 = 0; _i536 < _list534.size; ++_i536)
          {
            _elem535 = iprot.readI64();
            struct.used_ports.add(_elem535);
          }
        }
        struct.set_used_ports_isSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.meta = new ArrayList<Long>(_list537.size);
          long _elem538;
          for (int _i539 = 0; _i539 < _list537.size; ++_i539)
          {
            _elem538 = iprot.readI64();
            struct.meta.add(_elem538);
          }
        }
        struct.set_meta_isSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.scheduler_meta = new HashMap<String,String>(2*_map540.size);
          String _key541;
          String _val542;
          for (int _i543 = 0; _i543 < _map540.size; ++_i543)
          {
            ...
            struct.scheduler_meta.put(_key541, _val542);
          }
        }
        struct.set_scheduler_meta_isSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TMap _map544 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.resources_map = new HashMap<String,Double>(2*_map544.size);
          String _key545;
          double _val546;
          for (int _i547 = 0; _i547 < _map544.size; ++_i547)
          {
            _key545 = iprot.readString();
            _val546 = iprot.readDouble();
            struct.resources_map.put(_key545, _val546);
          }
        }
        struct.set_resources_map_isSet(true);
      }
