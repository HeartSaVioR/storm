...
public class TopologyStats implements org.apache.thrift.TBase<TopologyStats, TopologyStats._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyStats> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.window_to_emitted = new HashMap<String,Long>(2*_map360.size);
                String _key361;
                long _val362;
                for (int _i363 = 0; _i363 < _map360.size; ++_i363)
                {
                  ...
                  struct.window_to_emitted.put(_key361, _val362);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.window_to_transferred = new HashMap<String,Long>(2*_map364.size);
                String _key365;
                long _val366;
                for (int _i367 = 0; _i367 < _map364.size; ++_i367)
                {
                  ...
                  struct.window_to_transferred.put(_key365, _val366);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.window_to_complete_latencies_ms = new HashMap<String,Double>(2*_map368.size);
                String _key369;
                double _val370;
                for (int _i371 = 0; _i371 < _map368.size; ++_i371)
                {
                  ...
                  struct.window_to_complete_latencies_ms.put(_key369, _val370);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.window_to_acked = new HashMap<String,Long>(2*_map372.size);
                String _key373;
                long _val374;
                for (int _i375 = 0; _i375 < _map372.size; ++_i375)
                {
                  ...
                  struct.window_to_acked.put(_key373, _val374);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.window_to_failed = new HashMap<String,Long>(2*_map376.size);
                String _key377;
                long _val378;
                for (int _i379 = 0; _i379 < _map376.size; ++_i379)
                {
                  ...
                  struct.window_to_failed.put(_key377, _val378);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.window_to_emitted != null) {
        if (struct.is_set_window_to_emitted()) {
          oprot.writeFieldBegin(WINDOW_TO_EMITTED_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter380 : struct.window_to_emitted.entrySet())
            {
      ...
      if (struct.window_to_transferred != null) {
        if (struct.is_set_window_to_transferred()) {
          oprot.writeFieldBegin(WINDOW_TO_TRANSFERRED_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter381 : struct.window_to_transferred.entrySet())
            {
      ...
      if (struct.window_to_complete_latencies_ms != null) {
        if (struct.is_set_window_to_complete_latencies_ms()) {
          oprot.writeFieldBegin(WINDOW_TO_COMPLETE_LATENCIES_MS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter382 : struct.window_to_complete_latencies_ms.entrySet())
            {
              oprot.writeString(_iter382.getKey());
              oprot.writeDouble(_iter382.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.window_to_acked != null) {
        if (struct.is_set_window_to_acked()) {
          oprot.writeFieldBegin(WINDOW_TO_ACKED_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter383 : struct.window_to_acked.entrySet())
            {
              oprot.writeString(_iter383.getKey());
              oprot.writeI64(_iter383.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.window_to_failed != null) {
        if (struct.is_set_window_to_failed()) {
          oprot.writeFieldBegin(WINDOW_TO_FAILED_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter384 : struct.window_to_failed.entrySet())
            {
  ...
  private static class TopologyStatsTupleScheme extends TupleScheme<TopologyStats> {
      ...
      if (struct.is_set_window_to_emitted()) {
        {
          ...
          for (Map.Entry<String, Long> _iter385 : struct.window_to_emitted.entrySet())
          {
            oprot.writeString(_iter385.getKey());
            oprot.writeI64(_iter385.getValue());
          }
        }
      }
      if (struct.is_set_window_to_transferred()) {
        {
          ...
          for (Map.Entry<String, Long> _iter386 : struct.window_to_transferred.entrySet())
          {
            oprot.writeString(_iter386.getKey());
            oprot.writeI64(_iter386.getValue());
          }
        }
      }
      if (struct.is_set_window_to_complete_latencies_ms()) {
        {
          ...
          for (Map.Entry<String, Double> _iter387 : struct.window_to_complete_latencies_ms.entrySet())
          {
            oprot.writeString(_iter387.getKey());
            oprot.writeDouble(_iter387.getValue());
          }
        }
      }
      if (struct.is_set_window_to_acked()) {
        {
          ...
          for (Map.Entry<String, Long> _iter388 : struct.window_to_acked.entrySet())
          {
      ...
      if (struct.is_set_window_to_failed()) {
        {
          ...
          for (Map.Entry<String, Long> _iter389 : struct.window_to_failed.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TopologyStats struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.window_to_emitted = new HashMap<String,Long>(2*_map390.size);
          String _key391;
          long _val392;
          for (int _i393 = 0; _i393 < _map390.size; ++_i393)
          {
            ...
            struct.window_to_emitted.put(_key391, _val392);
          }
        }
        struct.set_window_to_emitted_isSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.window_to_transferred = new HashMap<String,Long>(2*_map394.size);
          String _key395;
          long _val396;
          for (int _i397 = 0; _i397 < _map394.size; ++_i397)
          {
            ...
            struct.window_to_transferred.put(_key395, _val396);
          }
        }
        struct.set_window_to_transferred_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map398 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.window_to_complete_latencies_ms = new HashMap<String,Double>(2*_map398.size);
          String _key399;
          double _val400;
          for (int _i401 = 0; _i401 < _map398.size; ++_i401)
          {
            _key399 = iprot.readString();
            _val400 = iprot.readDouble();
            struct.window_to_complete_latencies_ms.put(_key399, _val400);
          }
        }
        struct.set_window_to_complete_latencies_ms_isSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.window_to_acked = new HashMap<String,Long>(2*_map402.size);
          String _key403;
          long _val404;
          for (int _i405 = 0; _i405 < _map402.size; ++_i405)
          {
            ...
            struct.window_to_acked.put(_key403, _val404);
          }
        }
        struct.set_window_to_acked_isSet(true);
      }
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TMap _map406 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.window_to_failed = new HashMap<String,Long>(2*_map406.size);
          String _key407;
          long _val408;
          for (int _i409 = 0; _i409 < _map406.size; ++_i409)
          {
            ...
            struct.window_to_failed.put(_key407, _val408);
          }
        }
        struct.set_window_to_failed_isSet(true);
      }
