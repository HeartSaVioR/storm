...
public class ThriftTopologyUtilsTest extends TestCase {
    ...
    public void testIsWorkerHook() {
        ...
        Assert.assertEquals(false, ThriftTopologyUtils.isWorkerHook(StormTopology._Fields.DEPENDENCIES));
    ...
    public void testIsDependencies() {
        ...
        Assert.assertEquals(true, ThriftTopologyUtils.isDependencies(StormTopology._Fields.DEPENDENCIES));
    }
